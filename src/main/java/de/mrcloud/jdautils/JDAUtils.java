...
public class JDAUtils {
    ...
    public static void greenBuilder2(String Title, String InfoText, Member member, TextChannel txtChannel, List<Emote> reactionToAdd) {
        EmbedBuilder embBuilder = new EmbedBuilder();
        embBuilder.setTitle(Title);
        embBuilder.setAuthor(member.getUser().getName(), member.getUser().getAvatarUrl(), member.getUser().getAvatarUrl());
        embBuilder.setColor(Color.decode("#2ecc71"));
    ...
    public static void privGeneral(Member member, String MessageColor, String Title, String Desc) {
        EmbedBuilder embBuilder = new EmbedBuilder();
        embBuilder.setTitle(Title);
        embBuilder.setAuthor(member.getUser().getName(), member.getUser().getAvatarUrl(), member.getUser().getAvatarUrl());
        embBuilder.setColor(Color.decode(MessageColor));
    ...
    /**
     * @param server   The guild this should be executed on
     * @param roleName The name of the role you want to search members with
     */
    ...
    public static void removeRoleFromMemberByString(Member member, String RoleName) {
